...
export const alt = "Lease Help by Location | LeasePlain";
    ...
    (
      ...
      >
        ...
        <p style={{
          ...
          Find tenant rights guides for your province, city, or US state
        </p>

        <div style={{ display: "flex", gap: "20px" }}>
          {["All Canadian provinces", "Major cities", "US states"].map((chip) => (
            <div key={chip} style={{
