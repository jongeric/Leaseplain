...
export const alt = "Lease Glossary | LeasePlain";
    ...
    (
      ...
      >
        ...
        <p style={{
          ...
          Plain-English definitions for every term in your residential lease
        </p>

        <div style={{ display: "flex", gap: "20px" }}>
          {["Security deposit", "Rent increase", "Subletting"].map((chip) => (
            <div key={chip} style={{
