...
const card=h("div",{style:{background:"linear-gradient(135deg, #1e3a5f 0%, #2563eb 100%)",width:"100%",height:"100%",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",fontFamily:"sans-serif",padding:"60px"}},
 ...
 h("div",{style:{display:"flex",fontSize:"62px",fontWeight:800,color:"white",textAlign:"center",lineHeight:1.1,letterSpacing:"-1px",marginBottom:"20px"}},"Ontario Tenant Questions, Answered"),
 h("div",{style:{display:"flex",fontSize:"25px",color:"rgba(255,255,255,0.8)",textAlign:"center",marginBottom:"48px",maxWidth:"800px",lineHeight:1.3}},"Straight, plain-English answers on rent, evictions, deposits & repairs"),
 h("div",{style:{display:"flex",gap:"24px"}},chip("Rent"),chip("Evictions"),chip("Deposits"),chip("Repairs")),
 h("div",{style:{position:"absolute",bottom:"32px",right:"48px",color:"rgba(255,255,255,0.5)",fontSize:"18px"}},"leaseplain.com"));
writeFileSync("public/og/answers.png",Buffer.from(await new ImageResponse(card,{...SIZE}).arrayBuffer()));
console.log("wrote public/og/answers.png");
