...
const NAV_TOOLS = [
  ...
  { label: "When Can My Rent Be Raised?", href: "/tools/rent-increase-date-calculator", desc: "Earliest legal increase date" },
  { label: "Move-Out Notice Calculator", href: "/tools/move-out-notice-calculator", desc: "Last day to give notice" },
