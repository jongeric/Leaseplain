...
export const alt = "LeasePlain – Understand Your Lease in Plain English";
    ...
    (
      ...
      >
        ...
        <h1 style={{
          ...
          Understand Your Lease<br />in Plain English
        </h1>

        <p style={{
          fontSize: "26px", color: "rgba(255,255,255,0.8)",
          textAlign: "center", margin: "0 0 48px", maxWidth: "700px",
        }}>
          Upload a PDF or paste your lease text — get an instant plain-English breakdown
        </p>

        <div style={{
          display: "flex", gap: "32px",
        }}>
          {["Red Flag Detection", "Financial Terms", "Questions to Ask"].map((f) => (
            <div key={f} style={{
