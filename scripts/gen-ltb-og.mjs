...
function chip(l){return h("div",{key:l,style:{display:"flex",alignItems:"center",gap:"10px",background:"rgba(255,255,255,0.15)",borderRadius:"12px",padding:"12px 20px",color:"white",fontSize:"20px",fontWeight:700}},l);}
const card=h("div",{style:{background:"linear-gradient(135deg, #1e3a5f 0%, #2563eb 100%)",width:"100%",height:"100%",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",fontFamily:"sans-serif",padding:"60px"}},
 ...
 h("div",{style:{display:"flex",fontSize:"64px",fontWeight:800,color:"white",textAlign:"center",lineHeight:1.1,letterSpacing:"-1px",marginBottom:"20px"}},"Ontario LTB Forms, Explained"),
 h("div",{style:{display:"flex",fontSize:"25px",color:"rgba(255,255,255,0.85)",textAlign:"center",marginBottom:"44px",maxWidth:"800px",lineHeight:1.3}},"Every N and T form in plain English — what it means and what to do"),
 h("div",{style:{display:"flex",gap:"18px"}},chip("N4"),chip("N12"),chip("N13"),chip("T2"),chip("T6")),
 h("div",{style:{position:"absolute",bottom:"32px",right:"48px",color:"rgba(255,255,255,0.6)",fontSize:"18px"}},"leaseplain.com"));
writeFileSync("public/og/ltb-forms.png",Buffer.from(await new ImageResponse(card,{...SIZE}).arrayBuffer()));
console.log("wrote public/og/ltb-forms.png");
