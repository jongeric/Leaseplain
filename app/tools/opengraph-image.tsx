...
export const alt = "Free Tenant Tools | LeasePlain";
    ...
    (
      ...
      >
        ...
        <p style={{
          ...
          9 free calculators — rent increase, deposits, notice periods, eviction checkers &amp; more
        </p>

        <div style={{ display: "flex", gap: "20px" }}>
          {["No sign-up", "Covers all provinces", "Instant results"].map((chip) => (
            <div key={chip} style={{
