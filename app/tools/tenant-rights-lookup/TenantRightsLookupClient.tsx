...
const PROVINCES: Record<string, ProvinceData> = {
  ...
  NB: {
    ...
    deposit: "Security deposit: max 1x monthly rent.",
    rent_control: "3% annual cap (effective Feb 1, 2025), up to 9% with Tribunal approval for renovations.",
    notice_rent_increase: "3 months written notice",
    notice_entry: "24 hours written notice",
    notice_eviction_nonpayment: "15 days",
    notice_landlord_end: "3 months",
    ...
    key_protections: [
      "Residential Tenancies Tribunal resolves disputes",
      "Deposit must be returned within 7 days",
      "3% annual rent cap as of 2025",
    ],
  },
  PE: {
    ...
    deposit: "Security deposit: max 1x monthly rent (1 week's rent for weekly tenancies).",
