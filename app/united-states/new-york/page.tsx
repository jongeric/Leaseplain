...
const faqItems = [
                  ...
                  { q: "What notice is required for eviction in New York?", a: "New York landlords must give proper written notice before starting eviction proceedings. For non-payment, a 14-day notice. For month-to-month tenancies, notice scales with tenancy length: 30 days (under 1 year), 60 days (1–2 years), or 90 days (2+ years)." },
