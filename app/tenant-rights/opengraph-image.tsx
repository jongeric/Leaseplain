...
export const alt = "Tenant Rights Guides | LeasePlain";
    ...
    (
      ...
      >
        ...
        <p style={{
          ...
          Province-by-province tenant rights, eviction rules, notice periods, and dispute resources
        </p>

        <div style={{ display: "flex", gap: "20px" }}>
          {["Canada", "United States", "Plain English"].map((chip) => (
            <div key={chip} style={{
