...
export const metadata: Metadata = {
  title: "Find a Tenant Lawyer, Paralegal or Advocate in Canada | LeasePlain",
  description:
    "How to get tenant legal help across Ontario, BC, and Alberta — community legal clinics, duty counsel, paralegals, advocates, and lawyers. Find help by city, and see who can represent you at the LTB, RTB, or RTDRS.",
  alternates: { canonical: "https://leaseplain.com/tenant-lawyer" },
  openGraph: {
    title: "Find a Tenant Lawyer, Paralegal or Advocate in Canada | LeasePlain",
    description:
      "Clinics, advocates, paralegals, and lawyers — how to get tenant legal help in Ontario, BC, and Alberta, by city.",
...
export default function TenantLawyerHubPage() {
  const itemListSchema = {
    ...
    "@type": "ItemList",
    name: "Tenant Legal Help by City — Canada",
    url: "https://leaseplain.com/tenant-lawyer",
    itemListElement: DIRECTORY_CITIES.map((c, i) => ({
      "@type": "ListItem",
      position: i + 1,
      name: `Tenant legal help in ${c.name}`,
      ...
      <div className="flex flex-col min-h-full">
        ...
        <main>
          <section className="bg-slate-50 border-b border-slate-100 py-16 px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <h1 className="text-4xl font-bold text-slate-900">Find a Tenant Lawyer, Paralegal or Advocate</h1>
              </div>
              <p className="text-lg text-slate-600 max-w-2xl leading-relaxed speakable-summary">
                ...
                how tenant legal help works in Ontario, BC, and Alberta, and how to find it in your city.
              </p>
            </div>
          </section>
          ...
          <section className="py-14 px-4">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-2xl font-bold text-slate-900 mb-2">Your options in Ontario, from free to full representation</h2>
              <p className="text-slate-600 mb-8 max-w-2xl">
                You don&apos;t always need to hire a lawyer. Start at the top of this list — free and
                lower-cost help resolves most tenant issues. The ladder below is for Ontario;{" "}
                <span className="text-slate-700">BC and Alberta have their own free services</span> — open
                any BC or Alberta city page below to see the local options.
              </p>
              ...
              {([
                ...
                <div key={prov.code} className="mb-8 last:mb-0">
                  ...
                  <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    {DIRECTORY_CITIES.filter((c) => c.province === prov.code).map((c) => (
                      <Link
                        key={c.slug}
          ...
          <section className="py-14 px-4">
            <div className="max-w-4xl mx-auto grid lg:grid-cols-2 gap-12 items-start">
              <div>
                <h2 className="text-2xl font-bold text-slate-900 mb-3">Are you a paralegal, advocate, or tenant lawyer?</h2>
                <p className="text-slate-600 leading-relaxed mb-4">
                  LeasePlain sends a steady stream of tenants across Ontario, BC, and Alberta researching
                  their rights. Get listed in our directory so renters in your area can find you when they
                  need help at the LTB, RTB, or RTDRS.
                </p>
                <ul className="space-y-2 text-sm text-slate-700">
                  ...
                  <li className="flex items-start gap-2"><ChevronRight className="w-4 h-4 text-indigo-500 mt-0.5 flex-shrink-0" aria-hidden="true" /> We verify credentials with the relevant law society before any listing goes live.</li>
