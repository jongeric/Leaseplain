...
const laTenantProtections = [
  ...
  "Security deposits are capped at 1 month's rent under California Civil Code 1950.5 (as amended by AB 12, effective July 2024) — a small-landlord exception (2 or fewer rental properties, 4 or fewer total units) allows up to 2 months' rent regardless of whether the unit is furnished. Landlords must return deposits within 21 days of move-out.",
