...
export const alt = "Tenant Rights Blog | LeasePlain";
    ...
    (
      ...
      >
        ...
        <p style={{
          ...
          Rent increase rules, eviction guides, and plain-English tenant rights updates
        </p>

        <div style={{ display: "flex", gap: "20px" }}>
          {["Ontario", "BC", "Alberta", "Quebec"].map((chip) => (
            <div key={chip} style={{
