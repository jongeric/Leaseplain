...
export const alt = "Lease Clause Explanations | LeasePlain";
    ...
    (
      ...
      >
        ...
        <p style={{
          ...
          What every clause in your lease actually means — and when it&apos;s enforceable
        </p>

        <div style={{ display: "flex", gap: "20px" }}>
          {["10 clause types", "Province-specific rules", "Free"].map((chip) => (
            <div key={chip} style={{
