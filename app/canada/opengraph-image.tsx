...
export const alt = "Canadian Tenant Rights | LeasePlain";
    ...
    (
      ...
      >
        ...
        <h1 style={{
          ...
          Canadian Tenant Rights by Province
        </h1>
        ...
        <p style={{
          ...
          Know your rights under Ontario, BC, Alberta, Quebec &amp; more provincial tenancy laws
        </p>

        <div style={{ display: "flex", gap: "20px" }}>
          {["10 provinces covered", "Plain English", "Free guides"].map((chip) => (
            <div key={chip} style={{
